...
# ======================================================
# RiboLongShort Pipeline
# Generic interactive Bash workflow for Ribo-seq data
# ======================================================
...
PROJECT_DESCRIPTION="Ribo-seq project"
...
# Size modes generated by the pipeline
SIZE_MODES=("all_lengths" "28_36")

# Sample names used by the pipeline
SAMPLES=(
"sample_1"
"sample_2"
)

# Original run accessions
RUNS=(
"RUN_ACCESSION_1"
"RUN_ACCESSION_2"
)

# Map original run accession to sample name
declare -A RUN_MAP
RUN_MAP["RUN_ACCESSION_1"]="sample_1"
RUN_MAP["RUN_ACCESSION_2"]="sample_2"
